...
//! lexer.
class QsciLexerVal3 : public QsciLexer {
  Q_OBJECT
...
public:
  ...
  QsciLexerVal3(QObject *parent = 0, bool caseInsensitiveKeywords = false);

  //! Destroys the QsciLexerCPP instance.
  virtual ~QsciLexerVal3();
...
private:
  ...
  QsciLexerVal3(const QsciLexerVal3 &);
  QsciLexerVal3 &operator=(const QsciLexerVal3 &);
};
