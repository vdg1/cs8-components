...
formVariableDetailEditor::formVariableDetailEditor(QWidget *parent)
    : QWidget(parent), ui(new Ui::formVariableDetailEditor), m_variable(nullptr) {
  ui->setupUi(this);
}

formVariableDetailEditor::~formVariableDetailEditor() { delete ui; }
...
void formVariableDetailEditor::on_textEditDocumentation_textChanged() { emit modified(); }
